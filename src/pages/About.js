...
function About() {
  ...
  return (
    <div id="about" className=" text-white">
      ...
      >
        <div>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="text mb-30 text-black">
              ...
              <p className=" text-base mb-5">
                Our commitment to quality has enabled it to become a recognized
                name in the industry. With a strong focus on delivering products
                that meet global standards, <b>SCPL </b>
                has emerged as a trusted partner for clients around the world.
                Our expertise lies in the process of delivering premium quality
                from the source to the end customer that we have meticulously
                built and streamlined year after year.
              </p>
      ...
      <div id="vision" className="vision-area parallax">
        <div className="z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-12 lg:py-14 relative grid grid-cols-2 gap-6">
          <div data-aos="flip-left" data-aos-duration="3000">
            ...
            <p className="text-base">
              Our vision is to be a pioneering force in the global agricultural
              export industry, delivering exceptionally produced agro-products.
              By harnessing cutting-edge technology and fostering collaborative
              partnerships, we aim to set new standards in quality and
              responsibility.
            </p>
          </div>
      ...
      >
        <div className="section-title">
          ...
          <h2 className="text-3xl font-bold mb-5 text-gray-800">
            All these processes take place at our facilities in Guntur, Khammam,
            Chennai and Pipavav.
          </h2>
        </div>
            ...
            <article className="card">
              ...
              <div className="card_content">
                ...
                <p className="card_description">
                  Our facility at <b>Guntur (Andhra Pradesh)</b> is developed on
                  3.85 acres of land, with 56,000 sq. ft. warehouse facility and
                  88,000 sq.ft open facility- where we carry out all the
                  end-to-end execution of all our operations like processing,
                  drying, quality control, packing, storage, and stuffing for
                  all of our products.
                </p>
              </div>
            </article>
